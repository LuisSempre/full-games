...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 9961)), "/home/lucas/full-games/src/app/auth/page.tsx"],
    ...
    const pages = ["/home/lucas/full-games/src/app/auth/page.tsx"];
...
function LogIn() {
    ...
    const onFormDataSubmit = async ()=>{
        await (0,_firebase_auth__WEBPACK_IMPORTED_MODULE_3__/* .signInUserWithEmailAndPassword */ .B3)(formData.email, formData.password);
        router.push("/");
    };
            ...
            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                children: [
                    ...
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("button", {
                        ...
                        className: "bg-black text-white my-4 px-2 rounded-md uppercase",
                        children: "entrar"
                    })
                ]
            })
...
function LogUp() {
    ...
    const onFormDataSubmit = async ()=>{
        if (formData.password !== formData.confirmPassword) {} else {
            await (0,_firebase_auth__WEBPACK_IMPORTED_MODULE_3__/* .signUpUserWithEmailAndPassword */ .YL)(formData.email, formData.password);
            router.push("/");
        }
    };
    (0,react__WEBPACK_IMPORTED_MODULE_2__.useEffect)(()=>{
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (LogUp);
...
const proxy = (0,module_proxy.createProxy)(String.raw`/home/lucas/full-games/src/components/LogIn.tsx`)
...
;// CONCATENATED MODULE: ./src/components/LogUp.tsx

const LogUp_proxy = (0,module_proxy.createProxy)(String.raw`/home/lucas/full-games/src/components/LogUp.tsx`)

// Accessing the __esModule property and exporting $$typeof are required here.
// The __esModule getter forces the proxy target to create the default export
// and the $$typeof value is for rendering logic to determine if the module
// is a client boundary.
const { __esModule: LogUp_esModule, $$typeof: LogUp_$$typeof } = LogUp_proxy;
const LogUp_default_ = LogUp_proxy.default;


/* harmony default export */ const LogUp = (LogUp_default_);
;// CONCATENATED MODULE: ./src/app/auth/page.tsx



function SignIn() {
    return /*#__PURE__*/ jsx_runtime_.jsx("div", {
        className: "max-w-7xl mx-auto p-4 justify-center items-center flex",
        children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
            children: [
                /*#__PURE__*/ jsx_runtime_.jsx(LogIn, {}),
                /*#__PURE__*/ jsx_runtime_.jsx(LogUp, {})
            ]
        })
    });
}
/* harmony default export */ const page = (SignIn);
...
var __webpack_exports__ = __webpack_require__.X(0, [697,717,608], () => (__webpack_exec__(6528)));
